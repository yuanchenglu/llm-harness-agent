...
> Previous: none
> Next: [02 Brain Drives the Cerebellum](02-bidirectional-agent-en.md)
...
That leads to the next innovation — [Brain Drives the Cerebellum](02-bidirectional-agent-en.md): making the LLM not a passive executor inside the Harness, but an active participant that recognizes its own limitations and requests assistance from the Harness.
