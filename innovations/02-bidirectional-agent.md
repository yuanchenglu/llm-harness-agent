...
> Previous: [01 Agent Immune System](01-agent-immune-system-en.md)
> Next: [03 Attention Budget Management](03-attention-budget-en.md)
...
The [Immune System](01-agent-immune-system-en.md) solves "when the Agent screws up, how does it fix itself"—this is **post-error correction**.
