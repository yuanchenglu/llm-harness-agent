...
1. [Immune System](01-agent-immune-system.md) — Extract "must-comply constraints" from Prompt and crystallize them as Skills
2. [Brain Driving the Cerebellum](02-bidirectional-agent.md) — Let the LLM declare what it needs instead of the Harness guessing
3. [Attention Budget Management](03-attention-budget.md) — Allocate attention as a finite resource, don't waste it on noise
