...
AI   S OFTWARE  D EVELOPERS   AS  G ENERALIST  A GENTS
...
browsing ( e.g ., W EB A RENA ), among others.   Released under the permissive MIT
...
I  will write the  P ython code for starting a ser v er .
...
[ 6 ] C md RunAction (source=agent)

I  ha v e created a  P ython file  ` app . py `  that will 
display a list of numbers from 1 to 10 when you run 
it .  Let me run the ser v er for you:
...
[7] CmdRun Observation

[1] 1 24

*   S erving Flas k  app 'app '

  *   D ebug mode :  of f

WARNING:   T his is a development server.  D o not 
use it in a production deployment.  U se a 
production  WSGI  server instead .

  *   R unning on http : //1 2 7. 0 . 0 .1 : 5 000

P ress  CTRL+C  to  q uit
[ 8 ]  Br o ws eInte ra cti v eAction (source=agent)

T he ser v er is running on port 5000 with  PI D  1 24 .  Let 
me browse to the page at http :// 1 27 . 0 . 0 . 1 : 500 0
...
goto("http://127.0.0.1:5000")
 ...
 [ 9 ]  BrowserO u tp u tObservation

 [1,  2 ,  3 , 4, 5, 6, 7,  8 ,  9 , 1 0 ]
D oc k er  Sa nd b o x
I nte rac t iv e  Py t ho n 
(IPy t ho n )   S e rv e r
Bash   Sh e ll
Brows e r

Playwright Chromium
Ob serv a tion
w h ere e a c h   Action  e x ecu ti on 
l e a d s   t o  a n  Observation
E v ent  S t r e a m:   List[Action_1, 
Observation_1, Action_2, ...]

Agent :   Event History -> Action

Ru nt i m e :   Action -> Observation
A b s t rac t io n
where all Action-Observation(s) are tracked
E v ent  S t r e a m
Agent  Ru nt i m e
U s e r   I nte r f ac e
C o mm a nd  L i ne
W e b   UI
I D E   P l u g i n s
[...]
...
I nte rac t io n
O pen H a nd s -m ai n tai ne d

Action Execution API
Ac tion
O pen H a nd s   a u t o m ati c all y   i n stall  
“action execution API”   i n t o u s er -
pro v i ded  a r bit r a r y  doc k er  i m a g e s
...
2.1
A GENT  D EFINITION   AND  I MPLEMENTATION
...
Actions.
Inspired   by   CodeAct   ( Wang   et   al. ,   2024a ),   OpenHands   connects   an   agent   with
the   environment   through   a   core   set   of   general   actions.
Actions   IPythonRunCellAction
and   CmdRunAction   enable   the   agent   to   execute   arbitrary   Python   code   and   bash   com-
...
2.2
A GENT  R UNTIME :   H OW  E XECUTION   OF  A CTIONS  R ESULTS   IN  O BSERVATIONS
...
2.3
A GENT  S KILLS :   T HE  E XTENSIBLE  A GENT -C OMPUTER  I NTERFACE
...
existing file from a specified line; scrolling functions  scroll_up  and  scroll_down  for viewing
a   different   part   of   files.   It   also   contains   tools   that   support   reading   multi-modal   documents,   like
parse_image  and  parse_pdf  for extracting information from images using vision-language
models ( e.g ., GPT-4V) and reading text from PDFs, respectively.   A complete list of supported skills
can be found in § I .
2.4
A GENT  D ELEGATION :   C OOPERATIVE  M ULTI - AGENT  I NTERACTION
OpenHands allows interactions between multiple agents as well.   To this end, we use a special action
type  AgentDelegateAction , which enables an agent to delegate a specific subtask to another
...
3
A GENT H UB :   A   H UB   OF  C OMMUNITY -C ONTRIBUTED  A GENTS
...
Published as a conference paper at ICLR 2025
Table 1:   Comparison of different AI agent frameworks (§ C ). S WE  refers to ‘software engineering’.
...
| Framework Domain | UseG r r Ia np teh ric face S Tt oa on ld La ir bd ri az re yd &B u Cil ot d-i en E S xa en cd ub tio ox n Bu Bil rt o-i wn s W ereb CM olu lalt bi- oa rg ae tn iot n CH olu lam ba on ra-A tioI n AgentHub FE rv aa mlu ea wti oo rn k A Qge Cnt |
| --- | --- |
...
| SWE-Agent (Yang et al., 2024) gpt-4-1106-preview AutoCodeRover (Zhang et al., 2024b) gpt-4-0125-preview Aider (Gauthier) gpt-4o & claude-3-opus Moatless Tools (Örwall) claude-3.5-sonnet Agentless (Xia et al., 2024) gpt-4o | 18.0 19.0 26.3 26.7 27.3 | − − − − − | − − − − − − − − − − |
| Web Browsing Agents |  |  |  |
| Lemur (Xu et al., 2023) Lemur-chat-70b Patel et al. (2024) Trained 72B w/ synthetic data AutoWebGLM (Lai et al., 2024) Trained 7B w/ human/agent annotation Auto Eval & Refine (Pan et al., 2024) GPT-4 + Reflexion w/ GPT-4V | − − − − | 5.3 9.4 18.2 20.2 | − − − − − − − − |
| WebArena Agent (Zhou et al., 2023a) gpt-4-turbo | − | 14.4 | − − |
| Misc. Assistance Agents |  |  |  |
| AutoGPT (Gravitas, 2023) gpt-4-turbo | − | − | − 13.2 |
| Llama-2-70b-chat Few-shot Prompting gpt-3.5-turbo-16k + Chain-of-Thought (Rein et al., 2023) gpt-4 | − − | − − − | 28.1 − 29.6 − 38.8 − |
| OpenHands Agents |  |  |  |
| gpt-4o-mini-2024-07-18 CodeActAgent v1.8 gpt-4o-2024-05-13 claude-3-5-sonnet | 6.3 22.0 26.0 | 8.3 14.5 15.3 | − − ∗53.1 − 52.0 − |
...
| SWE-Agent (Yang et al., 2024) AutoCodeRover (Zhang et al., 2024b) Aider (Gauthier) | gpt-4-1106-preview gpt-4-0125-preview gpt-4o & claude-3-opus | 18.0 1.67 19.0 − 26.3 − |
| OH CodeActAgent v1.8 | gpt-4o-mini-2024-07-18 gpt-4o-2024-05-13 claude-3-5-sonnet@20240620 | 7.0 0.01 22.0 1.72 26.0 1.10 |
| HumanEvalFix (Muennighoff et al., 2024), 164 instances |  |  |
| Prompting, 0-shot | BLOOMZ-176B OctoCoder-15B DeepSeekCoder-33B-Instruct StarCoder2-15B | 16.6 − 30.4 − 47.5 − 48.6 − |
| SWE-agent, 1-shot (Yang et al., 2024) | gpt-4-turbo | 87.7 − |
| OH CodeActAgent v1.5, Generalist, 0-shot. | gpt-3.5-turbo-16k-0613 gpt-4o-2024-05-13 | 20.1 0.11 79.3 0.14 |
| BIRD (Li et al., 2023b), 300 instances |  |  |
| Prompting, 0-shot | CodeLlama-7B-Instruct CodeQwen-7B-Chat | 18.3 - 31.3 - |
| OH CodeActAgent v1.5 | gpt-4-1106-preview gpt-4o-2024-05-13 | 42.7 0.19 47.3 0.11 |
| ML-Bench (Tang et al., 2024b), 68 instances |  |  |
| prompting + BM25, 0-shot | gpt-3.5-turbo gpt-4-1106-preview gpt-4o-2024-05-13 | 11.0 - 22.1 - 26.2 - |
| SWE-Agent (Yang et al., 2024) Aider (Gauthier) | gpt-4-1106-preview gpt-4o | 42.6 1.91 64.4 - |
| OH CodeActAgent v1.5 | gpt-4o-2024-05-13 gpt-4-1106-preview gpt-3.5-turbo-16k-0613 | 76.5 0.25 58.8 1.22 13.2 0.12 |
| BioCoder (Python) (Tang et al., 2024b), 157 instances |  |  |
| prompting, 0-shot | gpt-3.5-turbo gpt-4-1106-preview | 11.0 - 12.7 - |
| OH CodeActAgent v1.5 | gpt-4o-2024-05-13 | 27.5 0.13 |
| Gorilla APIBench (Patil et al., 2023), 1775 instances |  |  |
| Prompting, 0-shot | claude-v1 gpt-4-0314 gpt-3.5-turbo-0301 | 8.7 - 21.2 - 29.7 - |
| Gorilla, finetuned for API calls, 0-shot (Patil et al., 2023; Touvron et al., 2023) | llama-7b | 75.0 - |
| OH CodeActAgent v1.5 | gpt-3.5-turbo-0125 gpt-4o-2024-05-13 | 21.6 0.002 36.4 0.04 |
| ToolQA (Zhuang et al., 2024), 800 instances |  |  |
| Prompting, 0-shot | ChatGPT + CoT ChatGPT Chameleon | 5.1 - 5.6 - 10.6 - |
| ReAct, 0-shot (Yao et al., 2023; OpenAI, 2024a) | gpt-3.5-turbo gpt-3 | 36.8 - 43.1 - |
| OH CodeActAgent v1.5 | gpt-3.5-turbo-0125 gpt-4o-2024-05-13 | 2.3 0.03 47.2 0.91 |
...
| Lemur (Xu et al., 2023) Patel et al. (2024) AutoWebGLM (Lai et al., 2024) Auto Eval & Refine (Pan et al., 2024) | Lemur-chat-70b Trained 72B with self-improvement synthetic data Trained 7B with human/agent hybrid annotation GPT-4 + Reflexion w/ GPT-4V reward model | 5.3 − 9.4 − 18.2 − 20.2 − |
| WebArena Agent (Zhou et al., 2023a) | gpt-3.5-turbo gpt-4-turbo | 6.2 − 14.4 − |
| OH BrowsingAgent v1.0 | gpt-4o-mini-2024-07-18 gpt-4o-2024-05-13 claude-3-5-sonnet-20240620 | 8.5 0.01 14.8 0.15 15.5 0.10 |
| OH CodeActAgent v1.8 via delegation to BrowsingAgent v1.0 | gpt-4o-mini-2024-07-18 gpt-4o-2024-05-13 claude-3-5-sonnet-20240620 | 8.3 − 14.5 − 15.3 − |
| MiniWoB++ (Liu et al., 2018), 125 environments |  |  |
| Workflow Guided Exploration (Liu et al., 2018) CC-NET (Humphreys et al., 2022) | Trained specialist model with environment exploration Trained specialist model with RL and human annotated BC | 34.6 − 91.1 − |
| OH BrowsingAgent v1.0 | gpt-3.5-turbo-0125 gpt-4o-2024-05-13 | 27.2 0.01 40.8 0.05 |
...
tasks through  multi-turn interactions  using  tools  and  natural language feedback  simulated by GPT-4.
...
| AutoGPT (Gravitas, 2023) | gpt-4-turbo | 13.2 − |
| OH GPTSwarm v1.0 | gpt-4-0125-preview gpt-4o-2024-05-13 | 30.2 0.110 32.1 0.050 |
| GPQA (Rein et al., 2023), diamond set, 198 instances (refer to §G, Tab. 7 for other subsets) |  |  |
| Human (Rein et al., 2023) | Expert human Non-expert human | 81.3 − 21.9 − |
...
| OH CodeActAgent v1.5 | gpt-4o-2024-05-13 gpt-3.5-turbo-0125 | 57.6 0.085 11.8 0.006 |
| MINT (Wang et al., 2024b): math subset, 225 instances |  |  |
| MINT Baseline Agent | gpt-4-0613 | 65.8 − |
| OH CodeActAgent v1.5 | gpt-4o-2024-05-13 gpt-3.5-turbo-16k-0613 | 77.3 0.070 33.8 0.048 |
| MINT (Wang et al., 2024b): code subset, 136 instances |  |  |
| MINT Baseline Agent | gpt-4-0613 | 59.6 − |
| OH CodeActAgent v1.5 | gpt-4o-2024-05-13 gpt-3.5-turbo-16k-0613 | 50.0 0.087 5.2 0.030 |
...
| Zero-shot Prompting (Zhang et al., 2024a) | gpt-4-0314 gpt-3.5-turbo-0613 | 40.0 − 27.0 − |
...
URL   https://github.
com/Significant-Gravitas/Auto-GPT , 2023.   6 ,  7 ,  10 ,  18
...
forum?id=VTF8yNQM66 .   1 ,  6 ,  7 ,  8 ,  17 ,  19
11
...
self-improving pipelines.   2024.   18
...
model-based web navigating agent.   arXiv preprint arXiv:2404.03648 , 2024.   7 ,  9
...
large-scale database grounded text-to-SQLs.   In  Thirty-seventh Conference on Neural Information
Processing Systems Datasets and Benchmarks Track , 2023b.   6 ,  8 ,  9 ,  17
...
URL  https://arxiv.org/abs/2305.06161 .   7
...
Learning Representations (ICLR) , 2018.   URL  https://arxiv.org/abs/1802.08802 .   6 ,  9 ,  17
...
Agentbench:   Evaluating llms as agents.   arXiv preprint arXiv:   2308.03688 , 2023.   6 ,  10 ,  17
...
The next generation, 2024.   URL  https://arxiv.org/abs/2402.19173 .   7
...
10.48550/ARXIV.2311.12983.   URL  https://doi.org/10.48550/arXiv.2311.12983 .   6 ,  9 ,  10 ,  17
...
large language models, 2024.   6 ,  7 ,  8 ,  17
...
William Zhuk, and Barret Zoph.   Gpt-4 technical report, 2024.   18
Jiayi Pan, Yichi Zhang, Nicholas Tomlin, Yifei Zhou, Sergey Levine, and Alane Suhr.   Autonomous
evaluation and refinement of digital agents.   arXiv preprint arXiv:2404.06474 , 2024.   7 ,  9 ,  18
...
arXiv   preprint
arXiv:2305.12295 , 2023.   10
Joon   Sung   Park,   Joseph   C.   O’Brien,   Carrie   J.   Cai,   Meredith   Ringel   Morris,   Percy   Liang,   and
Michael S. Bernstein.   Generative agents:   Interactive simulacra of human behavior, 2023.   18
...
preprint arXiv:2405.20309 , 2024.   7 ,  9
Shishir G. Patil, Tianjun Zhang, Xin Wang, and Joseph E. Gonzalez.   Gorilla:   Large language model
connected with massive apis.   arXiv preprint arXiv:2305.15334 , 2023.   6 ,  8 ,  17
...
Benchmark.   arXiv preprint arXiv:2311.12022 , 2023.   6 ,  7 ,  9 ,  10 ,  17 ,  23
...
10.18653/v1/2021.findings-acl.317.   URL  https://aclanthology.org/2021.findings-acl.317 .   6 ,  10 ,  17
14
...
(Supplement_1):i266–i276, 06 2024c.   ISSN 1367-4811.   6 ,  8 ,  17
...
Executable Code Actions Elicit Better LLM Agents.   In  ICML , 2024a.   2 ,  3 ,  4 ,  5 ,  17
...
multi-agent conversation framework.   arXiv preprint arXiv:2308.08155 , 2023.   1 ,  6 ,  18
...
preprint arXiv:2310.06830 , 2023.   7 ,  9
...
arXiv preprint arXiv:2311.10751 , 2023.   18
15
...
20 question games.   2024a.   6 ,  10 ,  17
...
framework for autonomous language agents, 2023b.   6 ,  18
...
E
Q UALITY  C ONTROL :   I NTEGRATION  T ESTS   FOR  A GENTS
...
F
H OW  O PEN H ANDS  R UNTIME   WORK
F.1
W ORKFLOW
...
processing results
F.2
H OW  O PEN H ANDS   BUILDS   AND   MAINTAINS   RUNTIME   IMAGES
...
G
A DDITIONAL  R ESULTS  F OR  GPQA B ENCHMARK
...
0.054
H
I N - CONTEXT  D EMONSTRATION   FOR  C ODE A CT SWEA GENT
